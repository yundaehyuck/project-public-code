...
def get_dataloader(
    ...
    #weight_list = samples_per_cls/np.sum(samples_per_cls)
    
    #weight_list2 = 1/np.array(samples_per_cls)
    ...
    #for img,label in notebook.tqdm(train_dataset):
        
        #weight_tensor.append(weight_list[label])
